...
pruning_scratch_res18 0 ./log/imagenet/scratch-resnet18-ratenorm1-ratedist0.4 1 0.4

pruning_pretrain_res18 0 ./log/imagenet/pretrain-resnet18-ratenorm1-ratedist0.3 1 0.3
pruning_scratch_res18 0 ./log/imagenet/scratch-resnet18-ratenorm1-ratedist0.3 1 0.3
}

run_res34(){
pruning_pretrain_res34 0 ./log/imagenet/pretrain-resnet34-ratenorm1-ratedist0.4 1 0.4
pruning_scratch_res34  0 ./log/imagenet/scratch-resnet34-ratenorm1-ratedist0.4 1 0.4

pruning_pretrain_res34 0 ./log/imagenet/pretrain-resnet34-ratenorm1-ratedist0.3 1 0.3
pruning_scratch_res34  0 ./log/imagenet/scratch-resnet34-ratenorm1-ratedist0.3 1 0.3

#pruning_pretrain_res34  0 ./log/imagenet/pretrain-resnet34-ratenorm0.7-ratedist0.1 0.7 0.1
#pruning_scratch_res34  0 ./log/imagenet/scratch-resnet34-ratenorm0.7-ratedist0.1 0.7 0.1
#
#pruning_pretrain_res34  0 ./log/imagenet/pretrain-resnet34-ratenorm0.8-ratedist0.1 0.8 0.1
#pruning_scratch_res34  0 ./log/imagenet/scratch-resnet34-ratenorm0.8-ratedist0.1 0.8 0.1
}
